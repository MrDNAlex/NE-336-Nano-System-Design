...
# Initial Guess
#yVals[0] = np.linspace(Ca0, Ca0/2, xVals.size)
...
def Solver (uGuess):
    ...
    yGuess = solve_ivp(dfdx, (xInit, xEnd), [CaInit, uGuess[0]], method="Radau")
...
solIVP = solve_ivp(dfdx, (0, 1), [Ca0, correctU[0]], t_eval=xVals, method="Radau")
